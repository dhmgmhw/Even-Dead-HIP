...
export default function SignInPage({navigation}) {
  ...
  _onAuthGoogle = async () => {
    const { type, accessToken, user, idToken } = await Google.logInAsync({
      androidClientId: '161728779966-m3u3d79dtk3f1eac5922csif029sokdd.apps.googleusercontent.com',
      expoClientId: '747037265612-5o4lk93m2n098dhirk4gshnqlugi86nv.apps.googleusercontent.com',
    //    GOOGLE_ANDROID_ID,
